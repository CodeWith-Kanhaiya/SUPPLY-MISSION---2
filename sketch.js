...
function setup() {
	...
	packageBody = Bodies.circle(width/2 , 200 , 1 , {restitution:0.6, isStatic:true});
	World.add(world, packageBody);

	packageBody1 = Bodies.circle(width/2 , 200 , 4 , {restitution:0.6, isStatic:true});
	World.add(world, packageBody1);

	packageBody2 = Bodies.circle(width/2 , 200 , 7 , {restitution:0.6, isStatic:true});
